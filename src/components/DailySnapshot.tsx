...
export function DailySnapshot({ enquiries, quotes, orders }: { enquiries: Enquiry[]; quotes: Quote[]; orders: Order[] }) {
  ...
  // Align labels so the last bar (today) always shows the real day-of-week letter
  ...
  return (
    <div className="bg-white border border-g200 rounded-[10px] shadow-sm mb-4 overflow-hidden">
