...
export function Blueprint() {
  ...
  const timeline = [
    ...
    { date: '✅ June 2026', event: 'V3 Stabilization + Sampling Module Born', desc: 'Post-launch schema fixes across Enquiry/Quotation/Order, PDF/DOCX/email overhaul with default signatory, Payment Terms/Incoterms/Insurance auto-fill from customer master, Packing Type persistence shipped (DB-backed, all 3 modules), Sampling module built from scratch (tracker + log form), Taxes & Charges section completed in Orders.' },
